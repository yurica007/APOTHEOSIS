...
InputState::InputState()
{
	...
	inputMapTable_[InputType::skip] = inputMapTable_[InputType::cancel];//スキップ
	...
	inputMapTable_[InputType::shot] = { {InputCategory::keybd, KEY_INPUT_Z},
									{InputCategory::pad, PAD_INPUT_2} };//弾
